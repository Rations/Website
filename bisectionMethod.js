...
{
	fm = document.forms[1];
	var oa = fm.first.value;
	var ob = fm.second.value;
	var t = fm.tolerance.value;
...
{
	fm = document.forms[1];
	var eq = fm.equation.value.trim().toLowerCase();
	var usableEq = Parser.parse(eq);
	return usableEq.evaluate({x: n});
}
